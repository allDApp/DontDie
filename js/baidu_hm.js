/**
 * Created by FCX on 5/9/2016.
 * 使用    sendHm("c7cc77576a5b1864d20a27626e42bdfb","14ms.net");
 *        sendHm("4868272110d53c835d1f354ded2b9c17","bbs.14ms.net");
 * 参数 id 百度统计id,百度网站中心获取代码处获取
 *     hm 百度统计站点 如 www.egret.com
 *
 */

var sendHm = function (id,dm) {
    console.log(id,dm);
    this.id = id ? id : "c7cc77576a5b1864d20a27626e42bdfb";
    this.dm = dm ? dm : "4868272110d53c835d1f354ded2b9c17";
    var setUp = {
        id : this.id,
        dm : this.dm
    };
//站点测试id
    var siteList = [
        {
            id : "c7cc77576a5b1864d20a27626e42bdfb",
            dm : "14ms.net",
            name : "host"
        },
        {
            id : "4868272110d53c835d1f354ded2b9c17",
            dm : "bbs.14ms.net",
            name : "bbs"
        },
    ];
//功能函数获得参数
    function getParas() {
        ...
        if ( p ) {
            ...
            for(var i = 0; i < paras.length; i++ ){
                ...
                if ( paras[i] ) {
                    var para = {};
                    para.key = paras[i].split('=')[0];
                    para.value = paras[i].split('=')[1];
                    t.push(para);
                }
            }
    ...
    var parset = function () {
        var p = getParas();
        //console.log(p);
        var value = p ? p[0].value : 0;
        //console.log(value);
        switch (parseInt(value)) {
            case  1:
                setUp.dm = siteList[0].dm;
                setUp.id = siteList[0].id;
                break;
            case  2:
                setUp.dm = siteList[1].dm;
                setUp.id = siteList[1].id;
                break;
            default :
                setUp.dm = siteList[0].dm;
                setUp.id = siteList[0].id;
    ...
    this.parset = parset;
    this.getUrlPars = getParas;
//发送统计数
var send = function() {
        //console.log(setUp.id,setUp.dm);
        var h = {}
            , mt = {}
            , c = {
                id: setUp.id,
