			...
			return {
				init: function() {
					...
					e.run(function() {
						...
						e.canvas.fillStyle("#90EE90").fillScreen().fillStyle("#FFF").drawString(l.moduleName, 0, u + 110, e.graphics.VCENTER, !1, null, null, "50px 微软雅黑 Light").drawImage("btns1", 0, 106, 480, 7, i - 480 >> 1, u + 140, 480, 7).drawImage("btns1", 0, 106, 480, 7, i - 480 >> 1, u + 555, 480, 7).fillStyle("#000").drawString(a(l.time, "秒"), 0, u + 340, e.graphics.VCENTER, !1, null, null, "60px 微软雅黑 Light").fillStyle("#000").drawString("历史最佳:" + a(l.bestTime, "秒"), 0, u + 400, e.graphics.VCENTER, !1, null, null, "30px 微软雅黑 Light")
						
						l.time > l.bestTime && e.canvas.fillStyle("#FF0").drawString("新纪录", 0, u + 240, e.graphics.VCENTER, !1, null, null, "50px 微软雅黑 Light"),
							e.buttonLayout.released("return") ? f() : e.buttonLayout.released("restart") && dp_share2(l.time);
							e.buttonLayout.released("list") ? list() : e.buttonLayout.released("restart") && dp_share2(l.time)
					...
					f();
					var list = function() {
						window.location.href="index.html?uid=" + e.localStorage.getItem("NotDieAnyoneBestTime" + l.module)
					};
					var l = {
							moduleName: "",
							module: 0,
